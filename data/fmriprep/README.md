This fmriprep folder contain results from the execution of the fmriprep pipeline which can be clone from this repository: https://github.com/nipreps/fmriprep
